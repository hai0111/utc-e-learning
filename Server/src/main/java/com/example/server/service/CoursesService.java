...
public interface CoursesService {
    ...
    ApiResponse<CourseResponse> getCourse(UUID courseId);
    ...
    ApiResponse<List<StudentDto>> getPageStudentsInCourse(int page, int size, UUID courseId, String search);

    ApiResponse<List<StudentDto>> getPageStudentsNotCourse(int page, int size, UUID courseId, String search);
